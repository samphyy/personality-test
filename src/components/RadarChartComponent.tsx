...
export default function RadarChartComponent({ result }: RadarChartProps) {
  ...
  if (!mounted) {
    return (
      <div className="w-full h-64 sm:h-72 flex items-center justify-center bg-slate-50 dark:bg-slate-900/50 rounded-2xl animate-pulse">
  ...
  return (
    <div className="w-full h-64 sm:h-72 md:h-80 flex flex-col items-center justify-center relative">
