...
import PrintRadarChart from './PrintRadarChart';
...
${shareUrl}`;
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10 print:py-0 print:px-0 print:space-y-0">
      ...
      {/* =========================================================================
          SCREEN-ONLY DASHBOARD VIEW (HIDDEN ON PRINT)
         ========================================================================= */}
      <div className="space-y-10 print:hidden">
        {/* Archetype Hero Card */}
        <div
          className="relative rounded-3xl p-6 sm:p-10 text-white bg-slate-900 shadow-xl shadow-brand-500/15 overflow-hidden"
          style={{
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl space-y-3">
            <div className="inline-flex items-center space-x-2 px-3 py-0.5 rounded-full bg-white/20 backdrop-blur-md text-[11px] font-bold uppercase tracking-wider text-teal-200">
            ...
            <div className="mt-3 pt-3 border-t border-white/20 flex items-start space-x-2.5 bg-white/10 backdrop-blur-sm rounded-xl p-3">
          ...
          <div className="lg:col-span-7 space-y-2.5">
            ...
            {traitKeys.map((key) => {
              ...
              return (
                <div
                  key={key}
                  className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-3.5 transition-all shadow-sm"
                >
                  ...
                  {isExpanded && (
                    <div className="mt-2 pt-2 border-t border-slate-100 dark:border-slate-800 text-[11px] text-slate-600 dark:text-slate-300 space-y-1.5">
      ...
      <div className="hidden print:block space-y-0 text-slate-900">
        ...
        <div className="print-page">
          <div className="space-y-2.5">
            ...
            <div className="flex items-center justify-between border-b-2 border-slate-900 pb-2 mb-1">
              <div className="flex items-center space-x-3">
                <div className="w-9 h-9 rounded-xl overflow-hidden shadow-sm flex items-center justify-center bg-brand-500 shrink-0">
                  <Image
                    src="/logo.png"
                    alt="YSAMPHY Logo"
                    width={36}
              ...
              <div className="text-right text-[9.5px] text-slate-600 font-medium">
                <p>{new Date(result.timestamp).toLocaleDateString(undefined, { dateStyle: 'long' })}</p>
                <p className="text-teal-800 font-bold">personality-test.ysamphy.com</p>
              </div>
            </div>

            {/* Archetype Hero Card */}
            <div
              className="print-avoid-break print-dark-card relative rounded-2xl p-4 text-white bg-slate-900 overflow-hidden"
              style={{
                background: 'linear-gradient(135deg, #0f172a 0%, #0f766e 50%, #042f2e 100%)',
                backgroundColor: '#0f172a',
                color: '#ffffff',
            ...
            >
              <div className="relative z-10 space-y-1.5">
                <div className="inline-flex items-center space-x-1.5 px-2.5 py-0.5 rounded-full bg-white/20 text-[9.5px] font-bold uppercase tracking-wider text-teal-200">
                  <Award className="w-3.5 h-3.5 text-teal-300" />
                  <span>Primary Archetype</span>
                </div>
                ...
                <p className="text-xs font-semibold text-teal-100 italic">
                  &ldquo;{result.archetype.tagline}&rdquo;
                </p>

                <p className="text-[9.5px] text-slate-100 leading-relaxed pt-0.5">
                  {result.archetype.description}
                </p>

                <div className="mt-2 pt-2 border-t border-white/20 flex items-start space-x-2 bg-white/15 rounded-xl p-2.5">
                  <Sparkles className="w-4 h-4 text-amber-300 shrink-0 mt-0.5" />
                  <div>
                    <h4 className="text-[9.5px] font-bold uppercase tracking-wider text-amber-200">
                      Core Growth Advice
                    </h4>
                    <p className="text-[9.5px] text-white/95 mt-0.5 leading-snug">
                      {result.archetype.growthAdvice}
                    </p>
                  </div>
                </div>
            ...
            {/* Radar Chart & Trait Snapshot Grid */}
            <div className="print-avoid-break grid grid-cols-12 gap-3 items-start">
              {/* Radar Chart Visual */}
              <div className="col-span-5 bg-white border border-slate-300 rounded-2xl p-3 shadow-none">
                <div className="flex items-center justify-between mb-1">
                  <h3 className="font-black text-[10.5px] text-slate-900">
                    Dimensional Map
                  </h3>
                  <span className="text-[8.5px] text-slate-500 font-medium">5 Factor Polygon</span>
                </div>
                <PrintRadarChart result={result} />
                <p className="text-[8px] text-center text-slate-500 mt-1">
                  Higher values indicate greater trait expression.
                </p>
              </div>
              ...
              <div className="col-span-7 space-y-1.5">
                <div className="flex items-center justify-between mb-0.5">
                  ...
                  <span className="text-[8.5px] text-slate-500 font-semibold">Normalized Scores</span>
                </div>
                ...
                {traitKeys.map((key) => {
                  ...
                  return (
                    <div
                      key={key}
                      className="bg-white border border-slate-300 rounded-xl p-2"
                    >
                      <div className="flex items-center justify-between gap-1 mb-1">
                        <div className="flex items-center space-x-1.5">
                          <div
                            className="w-4.5 h-4.5 rounded-md flex items-center justify-center font-bold text-[9.5px]"
                            style={{
                              backgroundColor: `${info.color}20`,
                              color: info.color,
                            }}
                          ...
                          <h4 className="font-bold text-slate-900 text-[10px] leading-tight">
                            {info.label}
                          </h4>
                        </div>
          ...
          {/* Page 1 Footer */}
          <div className="flex items-center justify-between border-t border-slate-300 pt-2 mt-[3cm] text-[8pt] text-slate-500 font-medium">
        ...
        <div className="print-page">
                ...
                return (
                  <div key={key} className="p-2.5 rounded-xl border border-slate-300 bg-white space-y-1.5">
                    <div className="flex items-center justify-between border-b border-slate-200 pb-1">
                      <div className="flex items-center space-x-1.5">
                        <span className="w-2.5 h-2.5 rounded-full" style={{ backgroundColor: info.color }} />
                        <h4 className="font-black text-[10.5px] text-slate-900">{info.label}</h4>
                      </div>
                      <span className="text-[9px] font-bold px-2 py-0.5 rounded bg-slate-100 text-slate-800 border border-slate-300">
                        {s.tier} • {s.percentage}% ({info.lowLabel} ⟷ {info.highLabel})
                      </span>
                    </div>

                    <p className="text-[9px] text-slate-700 leading-snug">{s.description}</p>

                    <div className="grid grid-cols-2 gap-2 pt-0.5 text-[8.5px]">
                      <div className="bg-emerald-50/70 p-1.5 rounded-lg border border-emerald-200">
                        <strong className="text-emerald-950 block font-bold mb-0.5">Key Strengths:</strong>
                      ...
                      <div className="bg-amber-50/70 p-1.5 rounded-lg border border-amber-200">
                        <strong className="text-amber-950 block font-bold mb-0.5">Growth Opportunities:</strong>
                        <ul className="space-y-0.5 text-slate-800">
                          {s.growthAreas.map((grw, idx) => (
                            <li key={idx} className="leading-tight">• {grw}</li>
                          ))}
                        </ul>
                      </div>
                    </div>
          ...
          {/* Page 2 Footer */}
          <div className="flex items-center justify-between border-t border-slate-300 pt-2 mt-[2cm] text-[8pt] text-slate-500 font-medium">
            <span>© 2026 YSAMPHY LLC • Validated IPIP Five-Factor Psychometrics</span>
        ...
        <div className="print-page">
          <div className="space-y-2.5">
            ...
            <div className="p-3 rounded-2xl border border-teal-300 bg-teal-50/40 space-y-2">
              <div className="flex items-center justify-between border-b border-teal-200 pb-1">
                <span className="text-[10px] font-black uppercase text-teal-950">Recommended Career Roles & Domains</span>
                <span className="text-[9px] text-slate-600 font-bold">Archetype: {result.archetype.name}</span>
              </div>

              <div className="flex flex-wrap gap-1.5">
                {result.archetype.idealRoles.map((role, idx) => (
                  <span key={idx} className="px-2.5 py-1 rounded-lg bg-white border border-teal-300 text-[9.5px] font-bold text-teal-950 shadow-xs">
                    {role}
                  </span>
                ))}
              </div>

              <div className="grid grid-cols-2 gap-2.5 pt-1 text-[9px] text-slate-700">
                <div className="p-2.5 bg-white rounded-xl border border-slate-200 space-y-1">
                  <strong className="text-slate-900 block font-bold text-[9.5px]">🏢 Ideal Workplace Environment:</strong>
                  <p className="leading-relaxed">{result.scores[result.dominantTraits[0]].careerInsights.idealEnvironment}</p>
                </div>
                <div className="p-2.5 bg-white rounded-xl border border-slate-200 space-y-1">
                  <strong className="text-slate-900 block font-bold text-[9.5px]">⚡ Work & Execution Style:</strong>
            ...
            <div className="space-y-2 pt-0.5">
              ...
              <div className="grid grid-cols-5 gap-2">
                {percentileStats.map((ps) => (
                  <div key={ps.traitKey} className="p-2 rounded-xl border border-slate-300 bg-white space-y-1 text-center shadow-xs">
                    <span className="font-black text-slate-900 text-[9.5px] block truncate">{ps.label}</span>
                    <span className="font-black px-1.5 py-0.5 rounded-md bg-purple-50 text-purple-900 border border-purple-200 text-[9.5px] block">
                      {ps.percentile}th %ile
                    </span>
                    <span className="text-[8.5px] text-teal-800 font-bold block">{ps.rarityTier}</span>
                    <p className="text-slate-600 text-[8px] leading-tight pt-0.5">{ps.higherThanText}</p>
                  </div>
                ))}
              </div>
        ...
        <div className="print-page">
          <div className="space-y-1.5">
            ...
            <div className="flex items-center justify-between bg-amber-50/70 p-2 rounded-xl border border-amber-200 text-xs">
              <div>
                ...
                <p className="text-[9px] text-slate-700 leading-tight">{growthPlan.summary}</p>
              </div>
              <span className="text-[9px] font-bold px-2 py-0.5 rounded-lg bg-amber-200 text-amber-900 shrink-0 ml-2">
          ...
          {/* Page 4 Footer */}
          <div className="flex items-center justify-between border-t border-slate-300 pt-1.5 mt-6 text-[8pt] text-slate-500 font-medium">
            <span>© 2026 YSAMPHY LLC • Validated IPIP Five-Factor Psychometrics</span>
        ...
        <div className="print-page">
          <div className="space-y-2">
            ...
            <p className="text-[9px] text-slate-600 bg-blue-50/50 p-2 rounded-xl border border-blue-200 leading-tight">
            ...
            <div className="p-2.5 rounded-xl border border-slate-300 bg-white space-y-1">
              ...
              <div className="space-y-0.5 text-[9px] text-slate-700">
                {careerAssets.resumeBullets.map((b, i) => (
                  <div key={i} className="px-2 py-0.5 rounded bg-slate-50 border border-slate-200">
            ...
            {/* All 3 Behavioral Interview Scripts */}
            <div className="p-2.5 rounded-xl border border-slate-300 bg-white space-y-1">
              ...
              <div className="space-y-1 text-[9px] text-slate-700">
                {careerAssets.interviewScripts.map((scr, i) => (
                  <div key={i} className="p-1.5 rounded bg-slate-50 border border-slate-200 space-y-0.5">
                    <strong className="text-slate-900 block font-bold text-[9px]">Q: {scr.question}</strong>
            ...
            <div className="p-2.5 rounded-xl border border-slate-300 bg-white space-y-0.5">
          ...
          {/* Page 5 Footer */}
          <div className="flex items-center justify-between border-t border-slate-300 pt-2 mt-12 text-[8pt] text-slate-500 font-medium">
            <span>© 2026 YSAMPHY LLC • Validated IPIP Five-Factor Psychometrics</span>
